"""
fire_reviews.db → fire_reviews_data.json (프론트용 export)
- build_reviews_json.py 의 소방판
"""
import sqlite3, json, re, os

conn = sqlite3.connect('fire_reviews.db')
